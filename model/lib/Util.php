...
class Util {
	...
	/**
	 * Array com a correlaзгo dos meses do ano em formato [A-Z]2[a-z] para 2[00-12]
	 * @var String[] 
	 */ 
	...
	/**
	 * Procura texto da notнcia em pбgina HTML
	 * @param String $url URL da pбgina HTML na qual se darб a busca
	 * @param String $selector Tag HTML na qual a pesquisa deverб ser feita
	 * @param String $texto Texto a procurar
	 * @return String $text Texto da notнcia
	 */
	...
	/**
	 * Busca todos os parвmetros para realizar pesquisas em fontes de informaзгo.
	 * Os parвmetros sгo todos os nomes de clube e de integrantes cadastrados no banco de dados
	 * @return String[] $param
	 */
